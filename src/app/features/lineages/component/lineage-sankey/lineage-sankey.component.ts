...
const financialData = [
  ['Banking System', 'Data Lake', 150],
  ['Credit Card Transactions', 'Data Lake', 200],
  ['Investment Platform', 'Data Lake', 100],
  ['Data Lake', 'ETL Process', 450],
  ['ETL Process', 'Data Warehouse', 450],
  ['Data Warehouse', 'Reporting Tools', 300],
  ['Data Warehouse', 'Risk Analysis Module', 150],
];
