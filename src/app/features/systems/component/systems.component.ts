...
export class SystemsComponent implements OnInit {
  ...
  saveChildGrid(parentRow: any) {
    ...
    this.systemDataModel.field_description =
      parentRow.childGridData[0].field_description;
    ...
    this.systemDataModel.risk_level_statement =
      parentRow.childGridData[0].risk_level_statement;

    console.log(this.systemDataModel, 'System Data Fields');

    this.systemService
      .createSystemDataFields(this.systemDataModel)
      .subscribe((res: any) => {
        if (res) {
