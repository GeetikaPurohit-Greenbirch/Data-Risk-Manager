...
categories = [
    ...
    blocks: [
      // 🔹 Single Block with basic input/output
      {
        ...
        ports: [
          ...
          { id: 'out1', group: 'in', attrs: { portLabel: { text: '', fill: '#00FA00',fontSize: 16 } } },
  ...
  // },
        ...
        color: '#fff',
        ports: [
          { id: 'out1', group: 'in',args: { x: 25, y: 50 }, attrs: { portLabel: { text: 'Report Status', fill: '#000',fontSize: 14 } } },
          { id: 'out2', group: 'in',args: { x: 25, y: 80 }, attrs: { portLabel: { text: 'Transaction Reference', fill: '#000',fontSize: 14 } } },
          { id: 'out3', group: 'in',args: { x: 25, y: 110 }, attrs: { portLabel: { text: 'Trading Venue', fill: '#000',fontSize: 14 } } }
        ],
        attrs: {
    title: {
      text: 'RTS 22',
